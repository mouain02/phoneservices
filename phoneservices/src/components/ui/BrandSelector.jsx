import { getBrandsByType } from "@/components/data/phones";
...
const BrandSelector = ({ deviceType, selectedBrand, onSelect }) => {
  const filteredBrands = getBrandsByType(deviceType);
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {filteredBrands.map((brand) => (
          <button
            ...
            className={`group h-28 sm:h-32 rounded-2xl border bg-secondary/50 transition-all duration-200 ${
